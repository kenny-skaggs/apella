<template>
    <div>
        <div class="my-trumbowyg-custom-icons-container" style="display: none">
            <!-- set a class to apply style below -->
...
export default {
    ...
    mounted() {
        ...
        let insertPluginsAvailable = ['link', 'table', 'insertImage', 'upload', 'mathml'];
        ...
        $(this.wizzySelector).trumbowyg({
            ...
            plugins: {
                upload: {
                    serverPath: this.$http.defaults.baseURL + '/curriculum/file-upload',
                    headers: {
                        Authorization: `Bearer${authToken}`
                    },
                    // error: <function for handling error>
                }
            }
        });
